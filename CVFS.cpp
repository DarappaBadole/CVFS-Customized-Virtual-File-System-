...
void man(char *name)
{
    ...
    {
        printf("Descriptor : Used to delete the file\n");
...
int main()
{
    ...
    while(1)
    {
        ...
        if(count == 1)
        {
            ...
            {
                CloseAllFile();
                printf("All files cloased successfully\n");
                continue;
            }
            ...
            {
                printf("Terminating the Marvellous File System\n");
                break;
            }
            else 
            {
        ...
        else if(count == 3)
        {
            ...
            else if(strcmp(command[0],"read") == 0)
            {
                ...
                if(ptr == NULL)
                {
                    printf("EOOR : Memory allocation failure\n");
                    continue;
                }
                ...
                if(ret == -4)
                    printf("ERROR : Int is not regular file\n");
                if(ret == 0)
